class TripHistoryStudentModel {
  String? date;
  String? startTime;
  String? endTime;
  List<SubData>? subData;

  TripHistoryStudentModel(
      {this.date, this.startTime, this.endTime, this.subData});

  TripHistoryStudentModel.fromJson(Map<String, dynamic> json) {
    date = json['date'];
